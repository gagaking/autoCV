...
bbox 格式：[xmin, ymin, xmax, ymax]。其中 xmin, ymin, xmax, ymax 均是 0 到 100 之间的百分比实数，数值代表该瑕疵区域在图二（生成海报图）中的百分比平面位置。必须严格遵守[横向起始, 纵向起始, 横向结束, 纵向结束]的顺序！
例如：[20.5, 30.0, 45.5, 60.0] 表示一个从横向 20.5% 到 45.5%（x轴），并且纵向从 30.0% 到 60.0%（y轴）的矩形框。
  ...
  "issues": [
    {
      ...
      "desc": "问题描述内容",
      "bbox": [xmin, ymin, xmax, ymax] // 0-100 的实数百分比坐标, 顺序: xmin, ymin, xmax, ymax
    }
  ]
}
`;
